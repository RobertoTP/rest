...
import com.usc.blog.domain.Blog;
import com.usc.blog.repository.BlogRepository;
import com.usc.blog.security.AuthoritiesConstants;
...
/**
 * REST controller for managing {@link com.usc.blog.domain.Blog}.
 */
@RestController
@RequestMapping("/api")
public class BlogResource {
     ...
     */
    @PostMapping(value = "/blogs", produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    @PreAuthorize("hasRole('ROLE_ADMIN') or hasRole('ROLE_REDACTOR')")
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping(value = "/blogs", produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    @PreAuthorize("hasRole('ROLE_ADMIN') or hasRole('ROLE_REDACTOR')")
     ...
     */
    @GetMapping(value = "/blogs", produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
     ...
     */
    @GetMapping(value = "/blogs/{id}", produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
     ...
     */
    @DeleteMapping(value = "/blogs/{id}", produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
